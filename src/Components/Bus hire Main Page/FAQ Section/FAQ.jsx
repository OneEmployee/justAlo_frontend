        ...
        <div>
            <div className={Styles.faqDivContainer}>
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    {arrow1 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>JUSTALO Hire helps you rent a vehicle from the best operators in your city.</div>}
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                            How does it work?
                            </div>
                    ...
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                            What are the benefits of booking or renting a vehicle with JUSTALO?
                            </div>
                    ...
                    {arrow10 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>JUSTALO, in light of the recent rapid spread of COVID-19, has introduced a new move which they call Safety+. Under Safety+, all buses are required to adhere to certain strict rules and guidelines. Some of these include regular and strict temperature checks along with advisories, making the use of masks mandatory for all employees as well as passengers, and sanitisers must be provided before boarding and present on all buses at all times.</div>
                    }
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                            How long is JUSTALO Bus Hire customer care available?
                            </div>
                    ...
                    {arrow11 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>JUSTALO customer care is available at all hours, that is, 24/7. The customer care staff are friendly and can be asked about any JUSTALO bus hire questions without hesitation.</div>
                    }
                    <div className={Styles.faqsEachDiv}>
                        <div className={Styles.faqDivText}>
                            Will there be blankets and linens provided in a complementary fashion aboard the Vehicle with JUSTALO?
                            </div>
                    ...
                    {arrow12 === "upArrow" &&
                        <div className={Styles.faqsEachAnswerDiv}>For the time being, due to the current situation created by the pandemic, JUSTALO will not be allowing the provision of blankets and various other cover-ups. This measure falls under the Safety+ guidelines.</div>
                    }
