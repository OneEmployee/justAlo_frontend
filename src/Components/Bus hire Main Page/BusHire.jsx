  ...
  return (
    <div>
      <div className={Styles.baneer}>
          ...
          <div className={Styles.whyBookWithBushire_secondFeature}>
            <div className={Styles.whyBookWithBushire_insideFeature}>
              <div style={{ display: "flex", justifyContent: "flex-start" }}>
                ...
                >
                  <p style={{ fontSize: "14px", color: "#004F50" }}>
                    Introducing
                  </p>
                  <h3
                    style={{
        ...
        {/* hire and renting a bus with justalo */}
        <div className={Styles.VehicleYouCanGet}>
          <div className={Styles.bookInEasySteps_heading}>
            Hiring/Renting A Bus with JUSTALO
          </div>
          <div className={Styles.hireuswhenever_paraSection}>
            JUSTALO understands that comfort and enjoyment are important while
          ...
          <div className={Styles.hireuswhenever_paraSection}>
            You can also book a sleeper coach bus with JUSTALO. For long-distance
            night travel, travelling in a sleeper bus is the best option.
            Sleeper bus booking is possible online with JUSTALO Bus Hire.
          </div>
        </div>
        {/*booking online buses */}
        <div className={Styles.VehicleYouCanGet}>
          <div className={Styles.bookInEasySteps_heading}>
            Booking Buses Online with JUSTALO
          </div>
          <div className={Styles.hireuswhenever_paraSection}>
            JUSTALO has identified the public’s love of travel and has made the
        ...
        <div className={Styles.VehicleYouCanGet}>
          ...
          <div className={Styles.hireuswhenever_paraSection}>
            JUSTALO is amongst the list of renowned online bus booking websites.
            ...
            experienced drivers drive buses. JUSTALO makes booking an ordinary
            vehicle, such as a tempo traveller or minibus, for a group vacation
            much more comfortable and more accessible. JUSTALO offers customers
            ...
            JUSTALO bus hire and JUSTALO bus rental can be done either through the
            use of the official website or the easy to download JUSTALO
            application.
          </div>
          <div className={Styles.hireuswhenever_paraSection}>
            JUSTALO has been making sure to take care of all its customer’s
            health and also play a role in curbing the further spread of
            COVID-19. In a bid to do just this, JUSTALO has come out with an
        ...
        <div className={Styles.VehicleYouCanGet}>
          ...
          <ul className={Styles.list}>
            <li>
              ...
              that you choose is reliable and trustworthy like JUSTALO.
            </li>
            <li>
              <BsCircleFill style={{ marginRight: "10px", fontSize: "7px" }} />
              ...
              JUSTALO, through the provision of the filters option, allows its
